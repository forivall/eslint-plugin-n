...
/** @typedef {import('estree').ImportDeclaration & { importKind?: 'type' }} ImportDeclaration */
/** @typedef {import('estree').ImportExpression} ImportExpression */
/** @typedef {ExportAllDeclaration | ExportNamedDeclaration | ImportDeclaration | ImportExpression} ImportNode */
 ...
 * @returns {RuleListener} A list of found target's information.
 */
module.exports = function visitImport(
    ...
    const ruleOptions = context.options[optionIndex] || {}
    const ignoreTypeImport =
        ruleOptions.ignoreTypeImport === void 0
            ? false
            : ruleOptions.ignoreTypeImport
    const targets = []
