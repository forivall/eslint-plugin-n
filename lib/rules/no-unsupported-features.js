...
module.exports = {
    ...
    create(context) {
         ...
         *
         * @param {Extract<ASTNode, { arguments: any[] }>} node - The call expression node to check.
         ...
         *
         * @param {ClassDeclaration} node - The class node to check.
            ...
            "Program:exit"() {
                ...
                for (const name of NEW_BUILTIN_TYPES) {
                    for (const reference of getReferences([name])) {
                        ...
                        const parentNode = /** @type {Identifier} */ (node)
                            .parent
